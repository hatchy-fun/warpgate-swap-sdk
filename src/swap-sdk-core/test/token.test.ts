...
describe("Token", () => {
  ...
  describe("#equals", () => {
    it("fails if address differs", () => {
      expect(
        new Token(ChainId.BSC, ADDRESS_ONE, 18, "A").equals(
          new Token(ChainId.BSC, ADDRESS_TWO, 18, "B"),
        ),
      ).toBe(false);
    });
    ...
    it("false if chain id differs", () => {
      expect(
        new Token(ChainId.BSC_TESTNET, ADDRESS_ONE, 18, "A").equals(
          new Token(ChainId.BSC, ADDRESS_ONE, 18, "B"),
        ),
      ).toBe(false);
    });
    ...
    it("true if only decimals differs", () => {
      expect(
        new Token(ChainId.BSC, ADDRESS_ONE, 9, "A").equals(
          new Token(ChainId.BSC, ADDRESS_ONE, 18, "B"),
        ),
      ).toBe(true);
    });
    ...
    it("true if address is the same", () => {
      expect(
        new Token(ChainId.BSC, ADDRESS_ONE, 1, "A").equals(
          new Token(ChainId.BSC, ADDRESS_ONE, 18, "B"),
        ),
      ).toBe(true);
    });
