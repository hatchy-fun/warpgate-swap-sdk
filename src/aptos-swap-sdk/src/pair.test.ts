import { CurrencyAmount } from "../../swap-sdk-core/src";
...
describe("Pair", () => {
  it("should match Pair address", () => {
    const pair1 = Pair.getAddress(
      coinA,
      AptosCoin.onChain(ChainId.TESTNET).wrapped
    );
    expect(pair1).toMatchInlineSnapshot(
      `"0x44f4d8c47efc31c707cb9189a87233197a74dbe666a47b08fd2e7646bed992bc::swap::LPToken<0x1::aptos_coin::AptosCoin, 0x8c805723ebc0a7fc5b7d3e7b75d567918e806b3461cb9fa21941a9edc0220bf::devnet_coins::DevnetBTC>"`
    );

    expect(Pair.getAddress(coinA, coinB)).toMatchInlineSnapshot(
      `"0x44f4d8c47efc31c707cb9189a87233197a74dbe666a47b08fd2e7646bed992bc::swap::LPToken<0x8c805723ebc0a7fc5b7d3e7b75d567918e806b3461cb9fa21941a9edc0220bf::devnet_coins::DevnetBTC, 0x8c805723ebc0a7fc5b7d3e7b75d567918e806b3461cb9fa21941a9edc0220bf::devnet_coins::DevnetSOL>"`
    );
  ...
  it("should match Pair Reserves address", () => {
    expect(
      ...
      `"0x44f4d8c47efc31c707cb9189a87233197a74dbe666a47b08fd2e7646bed992bc::swap::TokenPairReserve<0x1::aptos_coin::AptosCoin, 0x8c805723ebc0a7fc5b7d3e7b75d567918e806b3461cb9fa21941a9edc0220bf::devnet_coins::DevnetBTC>"`
    );

    expect(Pair.getReservesAddress(coinA, coinB)).toMatchInlineSnapshot(
      `"0x44f4d8c47efc31c707cb9189a87233197a74dbe666a47b08fd2e7646bed992bc::swap::TokenPairReserve<0x8c805723ebc0a7fc5b7d3e7b75d567918e806b3461cb9fa21941a9edc0220bf::devnet_coins::DevnetBTC, 0x8c805723ebc0a7fc5b7d3e7b75d567918e806b3461cb9fa21941a9edc0220bf::devnet_coins::DevnetSOL>"`
    );
  ...
  it("should match LiquidityToken", () => {
    expect(
      new Pair(
        CurrencyAmount.fromRawAmount(coinA, "100"),
        CurrencyAmount.fromRawAmount(coinB, "200")
      ).liquidityToken
    ).toMatchInlineSnapshot(`
      Coin {
        "address": "0x44f4d8c47efc31c707cb9189a87233197a74dbe666a47b08fd2e7646bed992bc::swap::LPToken<0x8c805723ebc0a7fc5b7d3e7b75d567918e806b3461cb9fa21941a9edc0220bf::devnet_coins::DevnetBTC, 0x8c805723ebc0a7fc5b7d3e7b75d567918e806b3461cb9fa21941a9edc0220bf::devnet_coins::DevnetSOL>",
        "chainId": 2,
        "decimals": 8,
        "isNative": false,
        "isToken": true,
        "name": "Warpgate-BTC-SOL-LP",
